...
miles_run = 15
recovery_meal = "breakfast"
preferred_breakfast = "pancakes and eggs"

puts "I ran #{miles_run} miles today. Now I'm ready for a huge #{recovery_meal}
of #{preferred_breakfast}!"
